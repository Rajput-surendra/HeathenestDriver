...
const Color primary = Color(0xff006B15);
const Color secondary=Color(0xffB4772A );
const Color fontColor=Colors.black;
const Color grad1Color=Color(0xff006B15);
const Color grad2Color=Color(0xff006B15);
