final String appName = 'Healthenest Driver';

// final String baseUrl = 'https://alphawizztest.tk/vizzvefood/delivery_boy/app/v1/api/';
final String baseUrl = 'https://developmentalphawizz.com/healthenest_rename/delivery_boy/app/v1/api/';
...
const String ORDER_HISTORY = 'Order History';
...
const String WORK_HOURS = 'Working Hours';
...
const String ONLINE_LBL = 'Online';
const String CASH_LBL = 'Cash Payment';
const String CURBAL_LBL = 'Current Balance';
const String WITHDRAW_MONEY = 'Withdraw Balance';
const String PAY_ADMIN = 'Pay to admin';
...
const String noOrder = 'No Order Found..!!';
